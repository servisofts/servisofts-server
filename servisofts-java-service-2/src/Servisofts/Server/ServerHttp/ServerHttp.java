...
public class ServerHttp {
    ...
    public static void Start(int puerto) {
        HttpServer server;
        try {
            SConsole.warning("Try initializing HttpServer on port ( " + puerto + " )");
            ...
            HttpContext statsContext = server.createContext("/__stats");
            statsContext.setHandler(ApiStatsServer::GET);
