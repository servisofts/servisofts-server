...
public class SocketCliente extends Thread {
    ...
    public SocketCliente(JSONObject config, SSLSocket socket) throws IOException {
        ...
        this.start();
        this.Open = true;
        SConsole.succes("Socket Client ( " + config.getJSONObject("cert").getString("OU") + " ) ready!");
    ...
    public void send(String data) {
        ...
        SConsole.error(
                "----->Send -> " + config.getJSONObject("cert").getString("OU") + " ------------START-------------- \n"
                        + data.toString() + "\n-------------------------------------END------------");
