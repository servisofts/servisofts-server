...
public class RolPermiso {
    ...
    public void getAll(JSONObject obj, SSSessionAbstract session) {
        try {
            ...
            String consulta =  "select get_all('rol_permiso') as json";

            if(!obj.isNull("key_permiso")) consulta =  "select get_all('rol_permiso','key_permiso','"+obj.getString("key_permiso")+"') as json";
            
            if(!obj.isNull("key_rol")) consulta =  "select get_all('rol_permiso','key_rol','"+obj.getString("key_rol")+"') as json";
